    ...
    internal sealed class Configuration : DbMigrationsConfiguration<LexiconLMS.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(LexiconLMS.Models.ApplicationDbContext context)
        {
            ...
            var Users = new List<ApplicationUser>
            {
                ...
                new ApplicationUser
                {
                  UserName = "anders.svensson@lexicon.se",
                  Email ="anders.svensson@lexicon.se",
                  FirstName ="Anders",
                  LastName ="Svensson",
                  CourseId = context.Courses.FirstOrDefault(c => c.Name == "Java").CourseID},
            ...
            var ActivityType = new[]
           {
            ...
            {
                //Modul C# (ModuleId=4)
                new Activity {Name="C# Intro", Description="Extern föreläsare", StartDate = DateTime.Parse("2016-12-20 09:00:00"), EndDate=DateTime.Parse("2016-12-20 13:00:00"), ModuleId=1, ActivityTypeID=1},//Föreläsning
                new Activity {Name="1.3", Description="C# Fundamental with Visual Studio 2015", StartDate = DateTime.Parse("2016-12-21 09:00:00"), EndDate=DateTime.Parse("2016-12-21 12:00:00"), ModuleId=2, ActivityTypeID=2},//E-learning
                new Activity {Name="1.4 + 1.5", Description="C# Fundamental with Visual Studio 2015", StartDate = DateTime.Parse("2016-12-21 13:00:00"), EndDate=DateTime.Parse("2016-12-21 17:00:00"), ModuleId=3, ActivityTypeID=3},//E-learning
            ...
            // Add roles
            var teachers = new[] { "teacher1@lexicon.se", "teacher2@lexicon.se", "teacher3@lexicon.se", "teacher4@lexicon.se", "anders.svensson@lexicon.se" };
